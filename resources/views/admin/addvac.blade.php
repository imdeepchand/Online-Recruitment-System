        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-75px">
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h2 class="text-info">Add Vacancy</h2>
                            </div>   
                        </div>
                        </div>
                    </div>
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <form action="addvac" name="addvacan" id="addvac" method="POST">
                        {{csrf_field()}}
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Select Company</label>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" name="qu">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Job Description</label>
                            <div class="col-sm-12 col-md-10">
                               <textarea class="form-control" maxlength="200" name="jd"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Number Of Post</label>
                            <div class="col-sm-12 col-md-10">
                               <input class="form-control" type="text" name="nov">
                            </div>
                        </div>
                         <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="submit" class="btn btn-primary" name="sub" value="POST">
